class Node
  attr_accessor :value, :first_node, :second_node, :third_node, :fourth_node, :edge_value_one, :edge_value_two, :edge_value_three, :edge_value_four, :number_of_edges, :inclusionArray, :level,:prevNodepos
...
def display_array
  print self.inclusionArray
end
end
#end of node class


Root = Node.new 1, nil, "", 0, 0
...
for i in 0..string.length-1
  ...
  currentNode = Root
  traverselevel = 0
  for x in 0..searcharray.length-2
    if currentNode != nil
    num = currentNode.inclusionArray.index(searcharray[x])
